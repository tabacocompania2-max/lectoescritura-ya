...
const PricingSection = () => (
  <section id="pricing-section" className="py-12 md:py-16 px-4 bg-primary/5">
    <div className="container max-w-4xl mx-auto space-y-8">
      <div className="text-center space-y-2">
        <span className="text-primary font-bold text-sm uppercase tracking-wider">Precio especial</span>
        <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground">
          Por menos de lo que cuesta una clase particular, puedes darle una habilidad para toda la vida
        </h2>
        <p className="text-muted-foreground">Hoy todavía estás a tiempo de cambiar esto.</p>
      </div>
