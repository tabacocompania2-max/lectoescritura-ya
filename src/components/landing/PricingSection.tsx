        ...
        <div className="p-8 space-y-6">
          ...
          <div className="text-center space-y-3 pt-4 border-t border-border">
            ...
            <Button asChild size="lg" className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold text-lg px-10 py-6 rounded-xl shadow-float w-full sm:w-auto">
              <a href={CHECKOUT_URL} target="_blank" rel="noopener noreferrer" className="text-xs font-medium text-center mx-0 my-[8px] px-[30px] py-0">QUIERO EL PROGRAMA COMPLETO
